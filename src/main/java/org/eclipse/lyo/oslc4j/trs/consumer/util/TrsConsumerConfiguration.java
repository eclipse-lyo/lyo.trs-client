...
public class TrsConsumerConfiguration {
    ...
    private final TRSHttpClient httpClient;
    private final String mqttClientId;
    private final ScheduledExecutorService scheduler;

    public TrsConsumerConfiguration(final String sparqlQueryUrl, final String sparqlUpdateUrl,
            final String sparqlUsername, final String sparqlPassword, final TRSHttpClient httpClient,
    ...
    public TRSHttpClient getHttpClient() {
        return httpClient;
    }
}
